...
<div class="entry-content">
 ...
 <div id="locations-dropdown"><div id="dropdown-menu">	
<nav><div id="locations-dropdown-header">VIEW ANOTHER LOCATION</div>
    <ul>
...
<div id="locations-map"><?php the_field("map"); ?></div>
...
<div class="thumb1"><a href="<?php the_sub_field("location_photo"); ?>" onclick="swap(this); return false;"><img src="<?php the_sub_field("location_photo"); ?>" width="150" height="99" border="0" style="opacity: 0.4;" onmouseover="this.style.opacity=1;this.filters.alpha.opacity=100" onmouseout="this.style.opacity=0.4;this.filters.alpha.opacity=40"></a></div>
